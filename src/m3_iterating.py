...
def run_test_count_negatives():
    ...
    #test 6:
    expected = 3
    actual = count_negatives((-46, -93, 7, -5))
    print()
    ...
    #test 7:
    expected = 2
    actual = count_negatives((8, 13, -38, -67))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 7: oops, accidently changed this test, my bad
    expected = 1
    seq = [[1,2,3,4,5,6,7,8], ['does', 'this', 'count', '?'], [1097, 200049]]
    actual = count_short_ones(seq)
    print()
    print('Test 7 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 1
    seq = [['no', 'its', 'too', 'long'], ['this', 'works'], [5,2,4,1,3]]
    actual = count_short_ones(seq)
    print()
    print('Test 7 expected:', expected)
    print('       actual:  ', actual)
